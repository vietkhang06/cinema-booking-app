...
public class SnackAdapter extends RecyclerView.Adapter<SnackAdapter.SnackViewHolder> {
    ...
    // Giỏ hàng lưu trữ: Key là snackId, Value là số lượng
    ...
    class SnackViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Snack snack) {
            ...
            btnPlus.setOnClickListener(v -> {
                ...
                if (cartListener != null) cartListener.onCartUpdated(cartQuantities, snackList);
            });
            ...
            btnMinus.setOnClickListener(v -> {
                ...
                if (qty > 0) {
                    qty--;
                    if (qty == 0) cartQuantities.remove(snack.snackId);
                    else cartQuantities.put(snack.snackId, qty);
