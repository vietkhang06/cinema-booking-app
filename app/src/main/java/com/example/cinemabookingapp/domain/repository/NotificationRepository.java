...
public interface NotificationRepository {
    ...
    void sendNotification(Notification notification, ResultCallback<Notification> callback);
    ...
    ListenerRegistration listenToUserNotifications(String userId, ResultCallback<List<Notification>> callback);
