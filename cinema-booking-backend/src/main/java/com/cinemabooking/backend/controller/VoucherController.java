...
import com.cinemabooking.backend.dto.VoucherDTO;
...
public class VoucherController {
    ...
    public ResponseEntity<ApiResponse<VoucherDTO>> validateVoucher(
            @AuthenticationPrincipal String userId,
            @RequestBody com.cinemabooking.backend.dto.request.ValidateVoucherRequest request) throws ExecutionException, InterruptedException {
