...
import com.cinemabooking.backend.features.user.AttendanceDTO;
import com.cinemabooking.backend.features.user.UserDTO;
import com.cinemabooking.backend.features.user.ViolationDTO;
...
public class AdminStaffController {
    ...
    public ResponseEntity<ApiResponse<List<AttendanceDTO>>> getAllAttendances(
        ...
        try {
            ...
            CollectionReference coll = firestore.collection(AttendanceDTO.COLLECTION_NAME);
            Query query = coll;
    ...
    public ResponseEntity<ApiResponse<List<ViolationDTO>>> getAllViolations(
        ...
        try {
            ...
            CollectionReference coll = firestore.collection(ViolationDTO.COLLECTION_NAME);
            Query query = coll.whereEqualTo("deleted", false);
    ...
    public ResponseEntity<ApiResponse<ViolationDTO>> createViolation(
        ...
        try {
            ...
            violation.setCreatedByName(adminUser.getName() != null ? adminUser.getName() : adminUser.getEmail());
            violation.setDeleted(false);
            if (violation.getStatus() == null) {
                violation.setStatus("PENDING");
            }

            firestore.collection(ViolationDTO.COLLECTION_NAME).document(id).set(violation).get();
    ...
    public ResponseEntity<ApiResponse<ViolationDTO>> updateViolation(
        ...
        try {
            ...
            DocumentReference ref = firestore.collection(ViolationDTO.COLLECTION_NAME).document(id);
            ...
            ref.update(
                    ...
                    "penaltyAmount", updateData.getPenaltyAmount(),
                    "penaltyPoints", updateData.getPenaltyPoints(),
                    "notes", updateData.getNotes(),
                    "violationType", updateData.getViolationType(),
                    "description", updateData.getDescription(),
                    "severity", updateData.getSeverity()
            ).get();

            ViolationDTO updated = ref.get().get().toObject(ViolationDTO.class);
